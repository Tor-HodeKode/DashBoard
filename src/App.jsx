...
import { WidgetProvider } from "./components/ImpWidget";
...
const styles = {
  ...
  header:
    "col-span-2 row-start-1 row-end-2 flex items-center justify-center mb-3 p-3",
  ...
  footer:
    "col-span-2 row-start-3 row-end-4 flex items-center justify-center p-3",
};
